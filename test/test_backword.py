...
import argparse
import time
from utils.dataloader import lowlight_loader  # 修改 import 路徑
...
def lowlight(image_path, weight_col=5, weight_exp=10):
	...
	DCE_net.load_state_dict(torch.load(f'snapshots/weights_backword/exp{weight_exp}_col{weight_col}_E06_Epoch199.pth'))
